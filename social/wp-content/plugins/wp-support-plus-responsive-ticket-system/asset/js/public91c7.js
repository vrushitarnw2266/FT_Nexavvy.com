            ...
            xhr.upload.addEventListener("progress", function(evt){
                if (evt.lengthComputable) {
                    ...
                    jQuery('#wpsp_frm_attachment_'+page+'_'+wpsp_attachment_counter).css({
                        'background': '-webkit-linear-gradient(left, #1aaf1c '+percentComplete+'%, #ff0000 '+percentRemain+'%)'
                    });
                    jQuery('#wpsp_frm_attachment_'+page+'_'+wpsp_attachment_counter).css({
                        'background': '-moz-linear-gradient(left, #1aaf1c '+percentComplete+'%, #ff0000 '+percentRemain+'%)'
                    });
                    jQuery('#wpsp_frm_attachment_'+page+'_'+wpsp_attachment_counter).css({
                        'background': '-o-linear-gradient(left, #1aaf1c '+percentComplete+'%, #ff0000 '+percentRemain+'%)'
                    });
                    jQuery('#wpsp_frm_attachment_'+page+'_'+wpsp_attachment_counter).css({
                        'background': '-ms-linear-gradient(left, #1aaf1c '+percentComplete+'%, #ff0000 '+percentRemain+'%)'
                    });
                    jQuery('#wpsp_frm_attachment_'+page+'_'+wpsp_attachment_counter).css({
                        'background': 'linear-gradient(left, #1aaf1c '+percentComplete+'%, #ff0000 '+percentRemain+'%)'
                    });
                } else {
                    jQuery('#wpsp_frm_attachment_'+page+'_'+wpsp_attachment_counter).css({
